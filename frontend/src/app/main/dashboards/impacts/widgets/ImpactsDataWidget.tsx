...
import ImpactsDataType from '../types/ImpactsDataType';
...
function ImpactsDataWidget() {
	...
	const { title, overview, series, ranges, labels } = widgets.impactsDataObject as ImpactsDataType;
					...
					<div className="flex-auto grid grid-cols-4 gap-16 mt-24">
						<div className="col-span-2 flex flex-col items-center justify-center py-32 px-4 rounded-2xl bg-indigo-50 text-indigo-800">
							<Typography className="text-5xl sm:text-7xl font-semibold leading-none tracking-tight">
								{overview[currentRange]['cumulative-impacts']}
							</Typography>
							<Typography className="mt-4 text-sm sm:text-lg font-medium">Impactos Totales</Typography>
							<Typography className="mt-4 text-xs sm:text-md font-medium text-grey-800">
								Hasta la fecha
							</Typography>
						</div>
						<div className="col-span-2 flex flex-col items-center justify-center py-32 px-4 rounded-2xl bg-green-50 text-green-800">
							<Typography className="text-5xl sm:text-7xl font-semibold leading-none tracking-tight">
								{overview[currentRange]['cumulative-visits']}
							</Typography>
							<Typography className="mt-4 text-sm sm:text-lg font-medium">Visitas Realizadas</Typography>
							<Typography className="mt-4 text-xs sm:text-md font-medium text-grey-800">
								Hasta la fecha
							</Typography>
						</div>
						...
						>
							<Typography className="text-5xl font-semibold leading-none tracking-tight">
								{overview[currentRange]['missing-visit']}
							</Typography>
							<Typography className="mt-4 text-sm font-medium text-center">No realizadas</Typography>
						</Box>
						<Box
							sx={{
								backgroundColor: (_theme) =>
						...
						>
							<Typography className="text-5xl font-semibold leading-none tracking-tight">
								{overview[currentRange]['total-percent']} %
							</Typography>
							<Typography className="mt-4 text-sm font-medium text-center">Realizados</Typography>
						</Box>
						{/* <Box
							sx={{
								backgroundColor: (_theme) =>
