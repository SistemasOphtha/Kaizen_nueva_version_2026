...
import ThirdsImpactAssignedType from '../types/ThirdsImpactAssignedType';

/**
 * The ThirdsImpactAssignedWidget widget.
 */
function ThirdsImpactAssignedWidget() {
	const widgets = useAppSelector(selectWidgets);
	const { data, title } = widgets.countImpactsAssignedObject as ThirdsImpactAssignedType;
...
export default memo(ThirdsImpactAssignedWidget);
