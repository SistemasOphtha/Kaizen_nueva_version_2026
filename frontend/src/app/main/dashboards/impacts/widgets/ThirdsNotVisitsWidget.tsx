...
import ThirdsNotVisitsType from '../types/ThirdsNotVisitsType';

/**
 * The ThirdsNotVisitsWidget widget.
 */
function ThirdsNotVisitsWidget() {
	const widgets = useAppSelector(selectWidgets);
	const { data, title } = widgets.countThirdsNotVisitsObject as ThirdsNotVisitsType;
...
export default memo(ThirdsNotVisitsWidget);
