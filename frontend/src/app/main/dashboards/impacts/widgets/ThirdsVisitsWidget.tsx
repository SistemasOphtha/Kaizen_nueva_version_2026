...
import ThirdsVisitsType from '../types/ThirdsVisitsType';

/**
 * The ThirdsVisitsWidget widget.
 */
function ThirdsVisitsWidget() {
	const widgets = useAppSelector(selectWidgets);
	const { data, title } = widgets.countThirdsVisitsObject as ThirdsVisitsType;
...
export default memo(ThirdsVisitsWidget);
