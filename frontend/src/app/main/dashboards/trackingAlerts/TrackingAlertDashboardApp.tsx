...
import TrackingAlertDashboardAppHeader from './TrackingAlertDashboardAppHeader';
...
/**
 * The trackingAlert dashboard app.
 */
function TrackingAlertDashboardApp() {
	...
	return (
		<FusePageSimple
			header={<TrackingAlertDashboardAppHeader />}
			content={content}
...
export default TrackingAlertDashboardApp;
