 ...
 * Remove label
 */
export const removeLabel = createAppAsyncThunk<string, number>('calendarApp/labels/removeLabel', async (labelId) => {
...
export const labelsSlice = createSlice({
	...
	reducers: {
		toggleSelectedLabels: (state, action) => {
			state.selectedLabels = _.xor(state.selectedLabels, [action.payload]) as number[];
		},
