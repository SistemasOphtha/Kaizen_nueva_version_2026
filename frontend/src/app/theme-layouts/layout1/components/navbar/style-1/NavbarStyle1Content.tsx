...
function NavbarStyle1Content(props: NavbarStyle1ContentProps) {
	...
	return (
		<Root className={clsx('flex h-full flex-auto flex-col overflow-hidden', className)}>
			<div className="flex h-80 shrink-0 flex-row items-center justify-center px-20 md:h-96 relative">
				<Logo />
				<NavbarToggleButton className="h-40 w-40 p-0 absolute right-12" />
			</div>
